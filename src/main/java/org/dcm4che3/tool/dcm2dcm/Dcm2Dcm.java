...
public class Dcm2Dcm {
    ...
    public void transcodeWithTranscoder(InputStream src, final File dest) throws IOException {
    ...
    public void transcodeWithTranscoder(Attributes fmi, InputStream src, final File dest) throws IOException {
        DicomOutputStream out = new DicomOutputStream(dest);
        try (Transcoder transcoder = new Transcoder(src)) {
            transcoder.setIncludeFileMetaInformation(!nofmi);
            transcoder.setRetainFileMetaInformation(retainfmi);
            transcoder.setEncodingOptions(encOpts);
    ...
    public void transcodeWithTranscoder(File src, final File dest) throws IOException {
        transcodeWithTranscoder(new FileInputStream(src), dest);
    }
